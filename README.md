...
The OMG monomers and polymers are available at [Zenodo](https://zenodo.org/records/7556992). The diverse monomer-level chemical and physical properties from active learning are accessible from https://github.com/TheJacksonLab/OMG_PhysicalProperties.
