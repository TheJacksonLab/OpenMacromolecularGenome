...
if __name__ == '__main__':
    ...
    reactant_bags = list(product(di_carboxylic_acid_list, di_ol_list))[1000000:2000000]
    ...
    df_reactant_bags.to_csv(
        os.path.join(save_directory, f'eMolecule_reactant_bags_reaction_idx_{reaction_idx}_batch_2.csv'), index=False
    )
