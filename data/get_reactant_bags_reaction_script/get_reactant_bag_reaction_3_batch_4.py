...
if __name__ == '__main__':
    ...
    reactant_bags = list(product(di_carboxylic_acid_list, di_ol_list))[3000000:4000000]
    ...
    df_reactant_bags.to_csv(
        os.path.join(save_directory, f'eMolecule_reactant_bags_reaction_idx_{reaction_idx}_batch_4.csv'), index=False
    )
